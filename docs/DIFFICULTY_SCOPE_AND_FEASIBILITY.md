...
> **Repo focus:** this calibration is especially relevant to JoshBootloader, JoshFirmware, Secure/Measured Boot, firmware bring-up and the later JoshEC path. Proprietary DRAM/EC/platform constraints must be treated as architecture constraints rather than hidden TODOs.
